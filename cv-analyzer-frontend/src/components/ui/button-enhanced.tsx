  ...
  (
    ...
    const variants = {
      ...
      success: cn(
        ...
        'hover:from-accent-600 hover:to-accent-700 hover:shadow-md',
      ...
      gradient: cn(
        'bg-gradient-to-r from-primary-600 via-purple-600 to-accent-500 text-white shadow-lg',
    ...
    const renderIcon = (position: 'left' | 'right') => {
      const iconClasses = size === 'xs' ? 'w-3 h-3' : size === 'sm' ? 'w-3.5 h-3.5' : size === 'lg' ? 'w-5 h-5' : size === 'xl' ? 'w-6 h-6' : 'w-4 h-4';
